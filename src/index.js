...
let store = createStore(mmdbApp, composeEnhancers(applyMiddleware(thunk, axiosMiddleware(client), //second parameter options can optionally contain onSuccess, onError, onComplete, successSuffix, errorSuffix. This middleware automatically calls state change (dispatch) when axios requests finish (success or failure)
